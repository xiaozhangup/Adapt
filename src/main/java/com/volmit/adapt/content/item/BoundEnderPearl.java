...
public class BoundEnderPearl implements DataItem<BoundEnderPearl.Data> {
        ...
        if (t.getType().equals(Material.ENDER_PEARL)) {
            ...
            if (meta != null && meta.hasLore() && meta.lore() != null && !meta.lore().isEmpty()) {
                if (Components.plain(meta.lore().getFirst())
                        .contains(Components.plain(Localizer.component("items", "boundenderperal", "name")))) {
    ...
    public void applyMeta(Data data, ItemMeta meta) {
        ...
        meta.displayName(Localizer.component("items", "boundenderperal", "name"));
