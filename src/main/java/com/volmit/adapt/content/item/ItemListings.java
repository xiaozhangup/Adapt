...
public class ItemListings {
    ...
    public static List<Material> food = List.of(Material.APPLE, Material.BAKED_POTATO, Material.BEETROOT,
            ...
            Material.GOLDEN_CARROT, Material.HONEY_BLOCK, Material.MELON_SLICE, Material.MUSHROOM_STEW,
            Material.POISONOUS_POTATO, Material.POTATO, Material.PUFFERFISH, Material.PUMPKIN_PIE, Material.RABBIT_STEW,
            Material.BEEF, Material.CHICKEN, Material.COD, Material.MUTTON, Material.PORKCHOP, Material.SALMON,
            Material.ROTTEN_FLESH, Material.SPIDER_EYE, Material.COOKED_BEEF, Material.SUSPICIOUS_STEW,
    ...
    public static List<Material> fishingDrops = List.of(Material.COD, Material.COD, Material.COD, Material.COD,
            ...
            Material.LILY_PAD, Material.BOWL, Material.LEATHER, Material.STICK, Material.ROTTEN_FLESH, Material.STRING,
            Material.GLASS_BOTTLE, Material.BONE, Material.INK_SAC, Material.TRIPWIRE_HOOK);
