...
public class BoundEyeOfEnder implements DataItem<BoundEyeOfEnder.Data> {
        ...
        if (t.getType().equals(Material.ENDER_EYE)) {
            ...
            if (meta != null && meta.hasLore() && meta.lore() != null && !meta.lore().isEmpty()) {
                if (Components.plain(meta.lore().getFirst())
                        .contains(Components.plain(Localizer.component("items", "boundeyeofender", "name")))) {
    ...
    public void applyMeta(Data data, ItemMeta meta) {
        ...
        meta.displayName(Localizer.component("items", "boundeyeofender", "name"));
    }
