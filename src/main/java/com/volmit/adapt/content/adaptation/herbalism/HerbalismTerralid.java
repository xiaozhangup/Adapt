...
public class HerbalismTerralid extends SimpleAdaptation<HerbalismTerralid.Config> {
    ...
    public HerbalismTerralid() {
        ...
        registerRecipe(
                Shaped.builder().key("herbalism-dirt-terralid").ingredient(new MaterialChar('S', Material.WHEAT_SEEDS))
                        .ingredient(new MaterialChar('D', Material.DIRT)).shapes(List.of("SSS", "DDD"))
                        .result(new ItemStack(Material.GRASS_BLOCK, 3)).build());

    }

    @Override
    public void addStats(int level, Element v) {
        v.addLore(Localizer.components("herbalism", "terralid", "lore"));
    }
