...
public class BlockingSaddlecrafter extends SimpleAdaptation<BlockingSaddlecrafter.Config> {
    ...
    public BlockingSaddlecrafter() {
        ...
        registerRecipe(
                Shaped.builder().key("blocking-saddlecrafter").ingredient(new MaterialChar('I', Material.LEATHER))
                        .shapes(List.of("I I", "III")).result(new ItemStack(Material.SADDLE, 1)).build());
