...
public class HerbalismCraftableCobweb extends SimpleAdaptation<HerbalismCraftableCobweb.Config> {
    ...
    public HerbalismCraftableCobweb() {
        ...
        setDescription(Localizer.component("herbalism", "cobweb", "description"));
        setDisplayName(Localizer.component("herbalism", "cobweb", "name"));
    ...
    public void addStats(int level, Element v) {
        v.addLore(Components.mini("<green>+ </green><gray><lore></gray>",
                Placeholder.component("lore", Localizer.component("herbalism", "cobweb", "lore1"))));
    }
