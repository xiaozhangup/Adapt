...
public class WrappedField<C, T> {
    ...
    public WrappedField(Class<C> origin, String methodName) {
        ...
        try {
            ...
            Adapt.error("Failed to created WrappedField %s#%s: %s%s".formatted(origin.getSimpleName(), methodName,
    ...
    public T get(C instance) {
        ...
        try {
            ...
            Adapt.error("Failed to get WrappedField %s#%s: %s%s".formatted(field.getDeclaringClass().getSimpleName(),
